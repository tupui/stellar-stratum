    ...
    <div className={cn("max-w-lg mx-auto", className)}>
      ...
      <div className="flex justify-center relative z-10 -my-4">
        <div className="relative">
          ...
          {!onSwapDirection ? (
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 shadow-[0_8px_25px_-5px_rgba(147,51,234,0.4),0_0_0_6px_hsl(var(--background)),inset_0_2px_4px_rgba(255,255,255,0.2)] flex items-center justify-center relative">
              <ArrowDown className="h-5 w-5 text-white drop-shadow-sm" />
            </div>
          ) : (
            <Button
              onClick={onSwapDirection}
              className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 shadow-[0_8px_25px_-5px_rgba(147,51,234,0.4),0_0_0_6px_hsl(var(--background)),inset_0_2px_4px_rgba(255,255,255,0.2)] transition-all duration-200 hover:shadow-[0_12px_30px_-5px_rgba(147,51,234,0.5),0_0_0_6px_hsl(var(--background)),inset_0_2px_4px_rgba(255,255,255,0.2)] relative"
              size="sm"
            >
